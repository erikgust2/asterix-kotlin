...
internal fun Cat062CodecSupport.readAircraftDerivedData(buffer: ByteBuffer): AircraftDerivedData =
    decodeCat062Item("I062/380", "aircraftDerivedData") {
        val indicator = decodeCat062Item("I062/380", "aircraftDerivedData.indicator") { readCompoundIndicator(buffer) }
        ...
        if (isCompoundSubfieldPresent(indicator, 1)) {
            targetAddress = decodeCat062Item("I062/380", "aircraftDerivedData.targetAddress") { readUnsignedInt24(buffer) }
        }
        if (isCompoundSubfieldPresent(indicator, 2)) {
            targetIdentification =
                decodeCat062Item("I062/380", "aircraftDerivedData.targetIdentification") {
                    decodePackedCallsign(readBytes(buffer, 6))
                }
        }
        if (isCompoundSubfieldPresent(indicator, 3)) {
            magneticHeadingDegrees =
                decodeCat062Item("I062/380", "aircraftDerivedData.magneticHeadingDegrees") {
                    buffer.short.toUnsignedInt() * (360.0 / 65536.0)
                }
        }
        if (isCompoundSubfieldPresent(indicator, 4)) {
            indicatedAirspeed =
                decodeCat062Item("I062/380", "aircraftDerivedData.indicatedAirspeed") {
        ...
        if (isCompoundSubfieldPresent(indicator, 5)) {
            trueAirspeedKnots = decodeCat062Item("I062/380", "aircraftDerivedData.trueAirspeedKnots") { buffer.short.toUnsignedInt() }
        }
        if (isCompoundSubfieldPresent(indicator, 6)) {
            selectedAltitude =
                decodeCat062Item("I062/380", "aircraftDerivedData.selectedAltitude") {
                    val raw = buffer.short.toUnsignedInt()
                    SelectedAltitude(
        ...
        if (isCompoundSubfieldPresent(indicator, 7)) {
            finalStateSelectedAltitude =
                decodeCat062Item("I062/380", "aircraftDerivedData.finalStateSelectedAltitude") {
                    val raw = buffer.short.toUnsignedInt()
                    FinalStateSelectedAltitude(
        ...
        if (isCompoundSubfieldPresent(indicator, 8)) {
            trajectoryIntentStatus =
                decodeCat062Item("I062/380", "aircraftDerivedData.trajectoryIntentStatus") {
        ...
        if (isCompoundSubfieldPresent(indicator, 9)) {
            val rep = decodeCat062Item("I062/380", "aircraftDerivedData.trajectoryIntentData.size") { buffer.get().toUnsignedInt() }
            trajectoryIntentData =
                List(rep) { index ->
                    decodeCat062Item("I062/380", "aircraftDerivedData.trajectoryIntentData[$index]") {
                        readTrajectoryIntentPoint(buffer)
                    }
                }
        }
        if (isCompoundSubfieldPresent(indicator, 10)) {
            communicationsCapabilities =
                decodeCat062Item("I062/380", "aircraftDerivedData.communicationsCapabilities") {
        ...
        if (isCompoundSubfieldPresent(indicator, 11)) {
            adsbStatus =
                decodeCat062Item("I062/380", "aircraftDerivedData.adsbStatus") {
                    val raw = buffer.short.toUnsignedInt()
                    AdsbStatus(
        ...
        if (isCompoundSubfieldPresent(indicator, 12)) {
            acasResolutionAdvisoryReport =
                decodeCat062Item("I062/380", "aircraftDerivedData.acasResolutionAdvisoryReport") {
                    AcasResolutionAdvisory(readUnsignedInt56(buffer))
                }
        }
        if (isCompoundSubfieldPresent(indicator, 13)) {
            barometricVerticalRateFeetPerMinute =
                decodeCat062Item("I062/380", "aircraftDerivedData.barometricVerticalRateFeetPerMinute") {
        ...
        if (isCompoundSubfieldPresent(indicator, 14)) {
            geometricVerticalRateFeetPerMinute =
                decodeCat062Item("I062/380", "aircraftDerivedData.geometricVerticalRateFeetPerMinute") {
                    signExtend(buffer.short.toUnsignedInt() and 0x7FFF, 15) * 6.25
                }
        }
        if (isCompoundSubfieldPresent(indicator, 15)) {
            rollAngleDegrees = decodeCat062Item("I062/380", "aircraftDerivedData.rollAngleDegrees") { buffer.short.toDouble() * 0.01 }
        }
        if (isCompoundSubfieldPresent(indicator, 16)) {
            trackAngleRateDegreesPerSecond =
                decodeCat062Item("I062/380", "aircraftDerivedData.trackAngleRateDegreesPerSecond") {
                    val raw = buffer.short.toUnsignedInt()
        ...
        if (isCompoundSubfieldPresent(indicator, 17)) {
            trackAngleDegrees =
                decodeCat062Item("I062/380", "aircraftDerivedData.trackAngleDegrees") {
                    buffer.short.toUnsignedInt() * (360.0 / 65536.0)
                }
        }
        if (isCompoundSubfieldPresent(indicator, 18)) {
            groundSpeedKnots =
                decodeCat062Item("I062/380", "aircraftDerivedData.groundSpeedKnots") {
                    buffer.short.toUnsignedInt() * (1.0 / 16384.0) * 3600.0
                }
        }
        if (isCompoundSubfieldPresent(indicator, 19)) {
            velocityUncertaintyCategory =
                decodeCat062Item("I062/380", "aircraftDerivedData.velocityUncertaintyCategory") {
                    VelocityUncertaintyCategory.fromCode(buffer.get().toUnsignedInt() ushr 5)
                }
        }
        if (isCompoundSubfieldPresent(indicator, 20)) {
            meteorologicalData =
                decodeCat062Item("I062/380", "aircraftDerivedData.meteorologicalData") {
                    readMeteorologicalData(buffer)
                }
        }
        if (isCompoundSubfieldPresent(indicator, 21)) {
            emitterCategory =
                decodeCat062Item("I062/380", "aircraftDerivedData.emitterCategory") {
                    AircraftEmitterCategory.fromCode(buffer.get().toUnsignedInt())
                }
        }
        if (isCompoundSubfieldPresent(indicator, 22)) {
            positionWgs84 = decodeCat062Item("I062/380", "aircraftDerivedData.positionWgs84") { readWgs84Position(buffer) }
        }
        if (isCompoundSubfieldPresent(indicator, 23)) {
            geometricAltitudeFeet =
                decodeCat062Item("I062/380", "aircraftDerivedData.geometricAltitudeFeet") {
                    buffer.short.toDouble() * 6.25
                }
        }
        if (isCompoundSubfieldPresent(indicator, 24)) {
            positionUncertaintyCode =
                decodeCat062Item("I062/380", "aircraftDerivedData.positionUncertaintyCode") {
                    PositionUncertaintyCategory.fromCode(buffer.get().toUnsignedInt() and 0x0F)
                }
        }
        if (isCompoundSubfieldPresent(indicator, 25)) {
            val rep = decodeCat062Item("I062/380", "aircraftDerivedData.modeSMessages.size") { buffer.get().toUnsignedInt() }
            modeSMessages =
                List(rep) { index ->
                    decodeCat062Item("I062/380", "aircraftDerivedData.modeSMessages[$index]") {
        ...
        if (isCompoundSubfieldPresent(indicator, 26)) {
            indicatedAirspeedKnots =
                decodeCat062Item("I062/380", "aircraftDerivedData.indicatedAirspeedKnots") { buffer.short.toUnsignedInt() }
        }
        if (isCompoundSubfieldPresent(indicator, 27)) {
            machNumber = decodeCat062Item("I062/380", "aircraftDerivedData.machNumber") { buffer.short.toUnsignedInt() * 0.008 }
        }
        if (isCompoundSubfieldPresent(indicator, 28)) {
            barometricPressureSettingHpa =
                decodeCat062Item("I062/380", "aircraftDerivedData.barometricPressureSettingHpa") {
                    800.0 + ((buffer.short.toUnsignedInt() and 0x0FFF) * 0.1)
                }
        }
...
internal fun Cat062CodecSupport.writeAircraftDerivedData(
    ...
    encodeCat062Item("I062/380") {
        ...
        value.selectedAltitude?.let {
            require(it.flightLevel in -13.0..1000.0) {
                "aircraftDerivedData.selectedAltitude.flightLevel out of range: ${it.flightLevel}"
            }
        ...
        value.geometricAltitudeFeet?.let {
            ...
            buffer.putSignedShort(
                quantize(it, 6.25, "aircraftDerivedData.geometricAltitudeFeet"),
                "aircraftDerivedData.geometricAltitudeFeet",
            )
        }
