...
internal fun Cat062CodecSupport.readEstimatedAccuracies(buffer: ByteBuffer): EstimatedAccuracies =
    decodeCat062Item("I062/500", "estimatedAccuracies") {
        val indicator = decodeCat062Item("I062/500", "estimatedAccuracies.indicator") { readCompoundIndicator(buffer) }
        ...
        if (isCompoundSubfieldPresent(indicator, 1)) {
            positionCartesian =
                decodeCat062Item("I062/500", "estimatedAccuracies.positionCartesian") {
                    CartesianAccuracy(
        ...
        if (isCompoundSubfieldPresent(indicator, 2)) {
            xyCovarianceMeters = decodeCat062Item("I062/500", "estimatedAccuracies.xyCovarianceMeters") { buffer.short.toDouble() * 0.5 }
        }
        if (isCompoundSubfieldPresent(indicator, 3)) {
            positionWgs84 =
                decodeCat062Item("I062/500", "estimatedAccuracies.positionWgs84") {
                    Wgs84Accuracy(
        ...
        if (isCompoundSubfieldPresent(indicator, 4)) {
            geometricAltitudeFeet =
                decodeCat062Item("I062/500", "estimatedAccuracies.geometricAltitudeFeet") { buffer.get().toUnsignedInt() * 6.25 }
        }
        if (isCompoundSubfieldPresent(indicator, 5)) {
            barometricAltitudeFeet =
                decodeCat062Item("I062/500", "estimatedAccuracies.barometricAltitudeFeet") { buffer.get().toUnsignedInt() * 25.0 }
        }
        if (isCompoundSubfieldPresent(indicator, 6)) {
            trackVelocity =
                decodeCat062Item("I062/500", "estimatedAccuracies.trackVelocity") {
                    CartesianVelocity(
        ...
        if (isCompoundSubfieldPresent(indicator, 7)) {
            trackAcceleration =
                decodeCat062Item("I062/500", "estimatedAccuracies.trackAcceleration") {
        ...
        if (isCompoundSubfieldPresent(indicator, 8)) {
            rateOfClimbDescentFeetPerMinute =
                decodeCat062Item("I062/500", "estimatedAccuracies.rateOfClimbDescentFeetPerMinute") { buffer.get().toUnsignedInt() * 6.25 }
        }
    ...
    encodeCat062Item("I062/500") {
        ...
        value.geometricAltitudeFeet?.let {
            buffer.putUnsignedByte(
                quantize(it, 6.25, "estimatedAccuracies.geometricAltitudeFeet"),
                "estimatedAccuracies.geometricAltitudeFeet",
            )
        }
